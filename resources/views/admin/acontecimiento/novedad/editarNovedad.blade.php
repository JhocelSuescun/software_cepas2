      ...
      <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="green" id="wizardProfile">
                                <form id="form_editarNovedad" class="form-horizontal" role="form" method="POST" action="{{ route('cepa.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        <input type="hidden" class="form-control" name="id" value="{{$novedad->id}}">
                                        <div class="tab-pane" id="about">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group label-floating is-empty">
                                                        ...
                                                        <div class="fileinput-new thumbnail">
                                                            <img src="{{ asset ($novedad->imagen)}}" alt="...">
                                                        </div>
                                            ...
                                            <div class="col-lg-10 col-lg-offset-1">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group label-floating is-empty">
                                                        <label class="control-label"></label>
                                                        <input type="date" class="form-control" name="fecha" value="{{$novedad->fecha}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-10 col-lg-offset-1">
                                                <label class="col-sm-2 label-on-left">Información Detallada: </label>
                                                
                                            </div>
                                            <div class="col-lg-10 col-lg-offset-1">
                                                <textarea id="mytextarea" name="informacion">Next, start a free trial! <?php echo $novedad["informacion"] ?></textarea> 
                                            </div>
