      ...
      <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="green" id="wizardProfile">
                                <form id="form_editarNoticia" class="form-horizontal" role="form" method="POST" action="{{ route('cepa.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        <input type="hidden" class="form-control" name="id" value="{{$noticia->id}}">
                                        <div class="tab-pane" id="about">
                                            ...
                                            <div class="col-lg-10 col-lg-offset-1">
                                                <textarea id="mytextarea" name="informacion">Next, start a free trial! <?php echo $noticia["informacion"] ?></textarea> 
                                            </div>
